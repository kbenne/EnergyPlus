...
\begin{itemize}
  \item  Space 1A Office People, 75 people. (concatenated name, apportioned by space floor area)
  \item  Space 1B Office People, 25 people. (concatenated name, apportioned by space floor area)
  \item  Lunchroom People, 50 people.       (simple object name for a single space)
  \item  Space 1A Cleaning Crew, 2 people.  (full load applied to each space in SpaceList)
  \item  Space 1B Cleaning Crew, 2 people.
  \item  Space 2 Cleaning Crew, 2 people.
\end{itemize}
